...
| ![Screenshot](./assets/thumbs/agile.jpg)   | agile | **(Octopus) Agile Tariff pricing**<br /><br />Displays the cost p/kWh (pence per kilowatt hour) for each hour over the current day.<br />See the full [documentation here](https://developer.octopus.energy/docs/api/#list-tariff-charges) for more information <br />|
