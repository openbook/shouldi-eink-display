...
| ![Screenshot](./assets/thumbs/local.jpg) | generation | **Local generation for your region**<br /><br />Using a postcode supplied in the config.ini file, this display shows the current generation mix specific to your region. |
